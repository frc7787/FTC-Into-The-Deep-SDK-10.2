...
public class TestBucketAutoArm extends OpMode {
    ...
    private void extend(int targetPosition) {
        leaderExtensionMotor.setTargetPosition(targetPosition);
        leaderExtensionMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
    ...
    @Override public void loop() {
        if (homing) {
            ...
            double leaderExtensionPower = leaderExtensionMotor.getPower();

            followerExtensionMotorOne.setPower(leaderExtensionPower);
            followerExtensionMotorTwo.setPower(leaderExtensionPower);
        }

        homing = homingState != HomingState.COMPLETE;
    ...
    @Override public void init() {
        ...
        followerExtensionMotorOne.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        followerExtensionMotorTwo.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);

        leaderExtensionMotor.setDirection(DcMotorSimple.Direction.REVERSE);
        followerExtensionMotorOne.setDirection(DcMotorSimple.Direction.REVERSE);
        followerExtensionMotorTwo.setDirection(DcMotorSimple.Direction.REVERSE);

        rotationMotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        leaderExtensionMotor.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        followerExtensionMotorOne.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        followerExtensionMotorTwo.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
        ...
        switch (homingState) {
            ...
            case EXTENSION:
                if (extensionLimitSwitch.getState()) {
                    ...
                    followerExtensionMotorOne.setPower(0.0);
                    followerExtensionMotorTwo.setPower(0.0);
                ...
                leaderExtensionMotor.setPower(-0.5);
                followerExtensionMotorOne.setPower(-0.5);
                followerExtensionMotorTwo.setPower(-0.5);
                break;
            case ROTATION:
