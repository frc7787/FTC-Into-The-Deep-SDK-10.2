package org.firstinspires.ftc.teamcode.pedropathing.tests.automatic;
...
public final class ForwardVelocityTuner extends OpMode {
    ...
    public void init() {
        ...
        motors = Arrays.asList(frontLeftDriveMotor, backLeftDriveMotor, frontLeftDriveMotor, backRightDriveMotor);
